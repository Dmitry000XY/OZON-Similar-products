...
Проект строит список похожих товаров на основе поведения пользователей: просмотров, кликов, добавлений в корзину и
других действий. Ниже показан пример того, как результат модели может выглядеть в интерфейсе интернет-магазина.
